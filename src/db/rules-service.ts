...
export const DEFAULT_RULES = [
  ...
  // The escalation this describes is computed in src/lib/keepers.ts and shown
  // per player on the draft results page. Keep the two in step.
  "A keeper costs three rounds better than where the player went in the previous draft. A 7th-round pick is a 4th-round keeper the next year, and it compounds each year he is kept. Players taken in rounds 1-3 cannot be kept. Undrafted players cost a 12th.",
